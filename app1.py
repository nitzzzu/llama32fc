...
client = instructor.from_openai(OpenAI(base_url="http://host.docker.internal:11434/v1", api_key="dummy"), mode=instructor.Mode.JSON)

def process_command(user_input: str) -> str:
    function_result = client.chat.completions.create(
        model="llama3.2:3b-instruct-fp16", # meta-llama/llama-3.2-3b-instruct
